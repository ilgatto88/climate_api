...
async def test_create_municipality():
    ...
    await municipality_service.create_municipality(municipality)
    result = await municipality_service.fetch_municipality_by_id(99999)
...
async def test_delete_municipality():
    await municipality_service.remove_municipality(99999)
    municipality = await municipality_service.fetch_municipality_by_id(99999)
